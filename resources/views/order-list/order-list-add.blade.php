                    ...
                    <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="top d-flex flex-column gap-5">
                            <div class="d-flex gap-5">
                                ...
                                <label for="" class="form-check-label"><input name="name" type="text"
                                        required></label>
                            </div>
                            <div class="d-flex gap-5">
                                <span class="bg-primary-subtle px-3 py-2">產品圖片</span>
                                <label for="" class="form-check-label"><input name="image" type="file" required
                                        accept="image/*"></label>
                            </div>
                            <div class="d-flex gap-5">
                                <span class="bg-primary-subtle px-3 py-2">產品價格*</span>
                                <label for="" class="form-check-label"><input name="price" type="number"
